...
<div class="page-meta">By <a href="#" onclick="alert('Not implemented!');">${c.page.author}</a> | ${c.page.creation_date_string} | <a href="#comments">${h.plural(len(c.page.comments), 'Comment', 'Comments')}</a></div>
